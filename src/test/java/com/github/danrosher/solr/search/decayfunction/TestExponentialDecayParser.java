...
public class TestExponentialDecayParser extends SolrTestCaseJ4 {
    ...
    public void testIntNumericExponentialDecayParser() throws Exception {
        ...
        assertJQ(req(
            "df", "id",
            "b", "exp(test_i,5,40,5,0.5)",//field,scale,origin,offset,decay
            "q", "{!boost b=$b v=$qq}",
            "qq", "{!edismax }*:*",
            "sort", "score desc",
        ...
        assertJQ(req(
            "df", "id",
            "b", "exp(test_i,20,50,20,0.5)",//field,scale,origin,offset,decay
            "q", "{!boost b=$b v=$qq}",
            "qq", "{!edismax }*:*",
            "sort", "score desc",
            "rows", Integer.toString(vals.length),
    ...
    public void testDatePointFieldExponentialDecayParser() throws Exception {
        ...
        assertJQ(req(
            "df", "id",
            "b", "exp(pdate,\"+2DAY+6HOUR\",\"2021-07-20T00:00:00Z\",\"+3DAY\",0.5)",//field,scale,origin,offset,decay
            "q", "{!boost b=$b v=$qq}",
            "qq", "{!edismax }*:*",
            "sort", "score desc",
            "rows", Integer.toString(vals.length),
    ...
    public void testLatLonPointFieldExponentialDecayParser() throws Exception {
        ...
        assertJQ(req(
            "df", "id",
            "b", "exp(location,\"23.420770393818795km\",52.02471051274793, -0.49007556238612354,\"0km\",0.5)",//field,scale,origin_lat,origin_lon,offset,decay
            "q", "{!boost b=$b v=$qq}",
            "qq", "{!edismax }*:*",
            "sort", "score desc",
            "rows", "3",
